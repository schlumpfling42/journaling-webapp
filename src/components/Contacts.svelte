            ...
            { #each contact.contactNumbers as contactNumber(contactNumber.id)}
              <div class="contactNumber" on:click={selectNumber}>
                <div class="numberText">
                  ...
                  Zoom: <a href="{"https://zoom.us/j/"+ contactNumber.number}" target="#" on:click={() => copyPassword(contactNumber.password)}>{contactNumber.label ? contactNumber.label : contactNumber.number}</a>                  {:else}
